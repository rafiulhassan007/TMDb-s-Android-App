...
import com.grameenphone.digitalninja.data.model.populartvseries.Result
...
class PopularTvAdapter : ListAdapter<Result, PopularTvAdapter.ItemHolder>(DiffCallback()) {
    ...
    class ItemHolder(private var view: View) : RecyclerView.ViewHolder(view) {
        ...
        public fun bind(result: Result) {
            view.tv_title.text = result?.name
